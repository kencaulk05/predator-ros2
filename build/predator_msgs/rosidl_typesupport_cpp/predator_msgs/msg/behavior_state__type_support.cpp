...
static const _BehaviorState_type_support_symbol_names_t _BehaviorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, predator_msgs, msg, BehaviorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, predator_msgs, msg, BehaviorState)),
  }
};
...
{
  return &::predator_msgs::msg::rosidl_typesupport_cpp::BehaviorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, predator_msgs, msg, BehaviorState)() {
  return get_message_type_support_handle<predator_msgs::msg::BehaviorState>();
}
