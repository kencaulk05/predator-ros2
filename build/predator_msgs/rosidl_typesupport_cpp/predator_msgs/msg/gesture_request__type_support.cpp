...
static const _GestureRequest_type_support_symbol_names_t _GestureRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, predator_msgs, msg, GestureRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, predator_msgs, msg, GestureRequest)),
  }
};
...
{
  return &::predator_msgs::msg::rosidl_typesupport_cpp::GestureRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, predator_msgs, msg, GestureRequest)() {
  return get_message_type_support_handle<predator_msgs::msg::GestureRequest>();
}
