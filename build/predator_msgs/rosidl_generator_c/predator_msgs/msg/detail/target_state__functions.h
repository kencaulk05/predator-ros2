...
#ifndef PREDATOR_MSGS__MSG__DETAIL__TARGET_STATE__FUNCTIONS_H_
#define PREDATOR_MSGS__MSG__DETAIL__TARGET_STATE__FUNCTIONS_H_
 ...
 * )) before or use
 * predator_msgs__msg__TargetState__create()
 ...
 * calls
 * predator_msgs__msg__TargetState__init().
...
/**
 * It calls
 * predator_msgs__msg__TargetState__fini()
...
predator_msgs__msg__TargetState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * predator_msgs__msg__TargetState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * predator_msgs__msg__TargetState__Sequence__fini()
 * on the array,
...
#endif  // PREDATOR_MSGS__MSG__DETAIL__TARGET_STATE__FUNCTIONS_H_
