...
{
  new (message_memory) predator_msgs::msg::TargetState(_init);
}

void TargetState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<predator_msgs::msg::TargetState *>(message_memory);
  typed_message->~TargetState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TargetState_message_member_array[7] = {
  {
    "header",  // name
    ...
    offsetof(predator_msgs::msg::TargetState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, predicted_pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, is_tracked),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(predator_msgs::msg::TargetState, distance_to_robot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TargetState_message_members = {
  ...
  7,  // number of fields
  sizeof(predator_msgs::msg::TargetState),
...
{
  return &::predator_msgs::msg::rosidl_typesupport_introspection_cpp::TargetState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, predator_msgs, msg, TargetState)() {
  return &::predator_msgs::msg::rosidl_typesupport_introspection_cpp::TargetState_message_type_support_handle;
}
